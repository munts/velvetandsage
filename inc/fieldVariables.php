...
function getTheme($default = ''): array
{
    return [
        ...
        'choices' => [
            ...
            'blackBean' => __('Black Bean', 'flynt'),
            'cameoBrown' => __('Cameo Brown', 'flynt'),
            'velvetRed' => __('Velvet Red', 'flynt'),
            'goldFlame' => __('Gold Flame', 'flynt'),
            'sesame' => __('Sesame', 'flynt'),
            'whiteSwan' => __('White Swan', 'flynt'),
            'darkBrown' => __('Dark Brown', 'flynt'),
        ],
